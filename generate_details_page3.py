...
script_end = content.rfind('</body>')

if modal_start != -1 and script_end != -1:
    new_page = """  <!-- Machine Full Details Page -->
  <div id="analiza-machine-details" class="rep-page" style="display:none; animation: fadeIn 0.3s ease; position:absolute; top:80px; left:250px; right:0; bottom:0; background:var(--bg); z-index:50; padding:24px; overflow-y:auto;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:20px;">
        <div>
            ...
            <div style="display:flex; gap:16px; color:var(--text-muted); font-size:14px; font-weight:500;">
                <span style="display:flex; align-items:center; gap:6px;">🕹️ <span id="md-mix" style="color:#text);">...</span></span>
    ...
    <div style="flex:1;">
        ...
        <div id="md-content-loc" style="display:block;">
            ...
            <div id="pg-md-loc-table" class="pagination-container" style="padding:12px 20px;"></div>
        </div>
        ...
        <div id="md-content-res" style="display:none;">
            ...
            <div id="pg-md-res-table" class="pagination-container" style="padding:12px 20px;"></div>
        </div>
        ...
        <div id="md-content-pay" style="display:none;">
            ...
            <div id="pg-md-pay-table" class="pagination-container" style="padding:12px 20px;"></div>
        </div>
...
"""
    content = content[:modal_start] + new_page + content[script_end+7:]
    with open("index.html", "w") as f:
        f.write(content)
    print("Replaced modal with page successfully.")
else:
